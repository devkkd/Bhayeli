      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 pb-20">
        {categories.length === 0 ? (
          <div className="text-center py-24">
            <p className="text-[16px] text-gray-400">No categories available yet.</p>
            ...
            {categories.map((cat) => (
              <div key={cat._id} className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-2">
                  <h3 className="text-[#1a1a2e] text-[14px] md:text-[18px] font-medium leading-snug">{cat.title}</h3>
                  {cat.description && (

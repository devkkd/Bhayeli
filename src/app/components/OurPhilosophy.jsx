    ...
    <section className="w-full  px-6">
      <div className="max-w-7xl mx-auto text-center flex flex-col gap-6">
        ...
        <div className="flex items-center justify-center">
          <img src="/image/design/design-1.png" className="w-2/5 md:w-1/4" alt="divider" />
        </div>
...
<div className=" flex flex-col gap-2">
        ...
        <p className="text-[13.5px] md:text-[14px] text-gray-600 leading-relaxed">
          <span className="font-bold text-[#1a1a2e]">With over 20 years of experience,</span> we serve B2B clients worldwide, providing handcrafted fabrics
          for fashion, home textiles, and furnishing applications.
        </p>

        <p className="text-[13px] font-semibold text-[#1a1a2e]">Our Core Techniques:</p>
</div>
        {/* Techniques row */}
        <div className="flex flex-wrap items-center justify-center divide-x divide-gray-300 mt-2">
          {["Block Print", "Dabu Print", "Chikankari Embroidery", "Digital Print", "Appliqué Handwork"].map((t, i) => (
            <span
              key={i}
        ...
        <p className="text-[13.5px] md:text-[14px] text-gray-600 leading-relaxed mt-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 divide-x divide-gray-200">
          {[
            ...
            <div key={i} className="flex flex-col gap-3 px-5 py-2 first:pl-0 last:pr-0">
              <h3 className="font-philosopher text-[#1a1a2e] text-[16px] md:text-[18px] font-bold leading-snug">
                {val.title}
              </h3>
              <p className="text-[12px] text-gray-500 leading-relaxed">{val.desc}</p>
            </div>
          ))}
        </div>

  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2 px-1 flex-wrap">
        ...
        <button className="shrink-0 border border-gray-300 text-[#1a1a2e] text-[11px] font-semibold px-4 py-2 rounded-full hover:border-[#1a1a2e] hover:bg-gray-50 transition-colors whitespace-nowrap">
          + Add to Cart
        </button>
